...
// ----------------------------------------------------------------------------
// $Id: DSSKeyPairRawCodec.java,v 1.2 2002-01-11 21:31:00 raif Exp $
//
...
/**
 * An object that implements the {@link gnu.crypto.sig.IKeyPairCodec} operations
 * for the <i>Raw</i> format to use with DSS keypairs.<p>
 *
...
public class DSSKeyPairRawCodec implements IKeyPairCodec {
    ...
    *
    * <ol>
    *    <li>4-byte magic consisting of the constant: 0x474E5541,<li>
   ...
   public PublicKey decodePublicKey(byte[] k) {
    // magic
    if (k[0] != 0x47 || k[1] != 0x4E || k[2] != 0x55 || k[3] != 0x41) {
    ...
    *
    * <ol>
    *    <li>4-byte magic consisting of the constant: 0x474E5561,<li>
    *    <li>1-byte version consisting of the constant: 0x01,</li>
    *    <li>4-byte count of following bytes representing the DSA parameter
    *    <code>p</code> in internet order,</li>
    *    <li>n-bytes representation of a {@link java.math.BigInteger} obtained
   ...
   public PrivateKey decodePrivateKey(byte[] k) {
    // magic
    if (k[0] != 0x47 || k[1] != 0x4E || k[2] != 0x55 || k[3] != 0x61) {
       throw new IllegalArgumentException("magic");
    }
