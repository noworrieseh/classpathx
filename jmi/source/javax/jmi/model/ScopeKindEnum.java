...
public class ScopeKindEnum implements ScopeKind
{
   ...
   * 
   */
  public static final ScopeKindEnum INSTANCE_LEVEL = new ScopeKindEnum(
      "instance_level");
   ...
   * @param literalName
   */
  public ScopeKindEnum(String literalName)
  {
    super();
    ...
    ScopeKindEnum.typeName = Collections.unmodifiableList(list);
  }
