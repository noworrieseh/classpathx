...
public interface XmiWriter
{
  ...
  public Collection write(OutputStream stream, Collection objects, String xmiVersion)
    throws IOException;
  
  public Collection write(OutputStream stream, RefPackage extent, String xmiVersion)
    throws IOException;
