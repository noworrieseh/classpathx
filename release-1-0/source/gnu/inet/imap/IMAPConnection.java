/*
 * $Id: IMAPConnection.java,v 1.12 2004-06-08 19:05:27 dog Exp $
 ...
 * @version $Revision: 1.12 $ $Date: 2004-06-08 19:05:27 $
 */
          ...
          if (tag.equals (response.getTag ()))
            {
              ...
              if (id == OK)
                {
                  // The capability list may be contained in the response text.
          ...
          else if (response.isUntagged ())
            {
              if (id == CAPABILITY)
                ...
                {
                  // The capability list may be contained in the response code.
                  List code = response.getResponseCode ();
                  int len = code.size ();
